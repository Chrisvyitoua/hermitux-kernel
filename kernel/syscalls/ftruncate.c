...
/*
The implementation of the fonction ftruncate which is a call handler was made by taking inspiration on the creat.c 
located at hermitux-kernel/kernel/syscalls/creat.c.

- ftruncate system call implementation | int ftruncate(int fd, off_t length);
